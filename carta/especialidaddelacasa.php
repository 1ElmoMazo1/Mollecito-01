	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="platodeentrada.php"</script>';
			}
		}
	}
}
...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<br />
			<br />
            <h1 style="text-align: center">Especialidad de la casa</h1>
			<br />
			<?php
				$query = "SELECT * FROM casa ORDER BY id ASC";
				...
				?>
			<div class="col-md-4">
				<form method="post" action="especialidaddelacasa.php?action=add&id=<?php echo $row["id"]; ?>">
